...
class ATT_Decoder(nn.Module):
    def __init__(self, enc_hidden_size, dec_hidden_size, num_layers,  embedding_dim, dropout_rate,bidirectional=False):
        ...
        self.lstm = nn.LSTM(input_size=self.enc_hidden_size, hidden_size=self.dec_hidden_size, num_layers=self.num_layers,
...
if __name__ == "__main__":
    ...
    decoder = ATT_Decoder(256, 256, 4,256,0.1)
